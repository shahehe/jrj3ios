//
//  ZhouBaoTableViewController.m
//  jrj
//
//  Created by 廖兴旺 on 14/12/10.
...
@interface ZhouBaoTableViewController ()

@end

@implementation ZhouBaoTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    MKNetworkEngine *engine  = [[MKNetworkEngine alloc] init];
    NSString *url = [NSString stringWithFormat:@"http://218.249.192.55/jrj/index.php?file=%@",[self.data safeObjectForKey:@"file"]];
